...
// define AHBx and APBx bus address
...
#define USART1_BASEADDR 				(APB2PERIPH_BASE + 0x100)
...
//these registers are specific to STM32F429 MCU

typedef struct {

	__vo uint32_t MODER;                        //GPIO MODE REG Offset: 0x00
...
#include "stm32f429_rcc_driver.h"
#include "stm32f429_spi_driver.h"
#include "stm32f429_usart_driver.h"
